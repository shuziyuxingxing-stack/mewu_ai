<div align="center">
  ...
  <p>开源截图工具，支持 AI分析、标注、 提取文字、中外翻译、录屏、识别邮箱一键发件、识别屏幕出现的URL一键爬取、识别tele一键拨号。</p>
  <p>
...
**喵呜AI（MewuAI）是一款 Windows 开源 AI 截图标注软件**。
...
- **试卷作答**：识别题目，在原题作答区域内作答。
- **屏幕识别**：识别圈选的图片、表格、外语。表格可导出excel，外语可识别翻译。
- **标注**：圈选区域标注，连同注记一起保存。
- **录屏**：录制指定区域并保存。
- **图文提问AI**：引用截图或附件向AI提问。
- **便捷MCP**：屏幕出现邮箱地址，便捷向该邮箱发件。出现电话，便捷拨号。出现网址，便捷爬取。

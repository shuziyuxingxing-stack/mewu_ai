...
![网页标注 / Web annotations](https://raw.githubusercontent.com/abnste/mewu_ai/v0.2.0/docs/images/web-annotations.jpg)

**圈重点、打勾与打叉 / Highlight, check, and cross out**

![AI 标记 / AI marks](https://raw.githubusercontent.com/abnste/mewu_ai/v0.2.0/docs/images/ai-checkmarks.jpg)

**原位翻译，可选中复制 / Translate in place, then select and copy**

![原位翻译 / In-place translation](https://raw.githubusercontent.com/abnste/mewu_ai/v0.2.0/docs/images/in-place-translation.jpg)

**用一句话让 AI 动笔 / Ask AI to draw**

![AI 绘图 / AI drawing](https://raw.githubusercontent.com/abnste/mewu_ai/v0.2.0/docs/images/ai-drawing.jpg)

**代码与步骤可视化讲解 / Visual explanations of code and steps**

![代码讲解 / Code explanation](https://raw.githubusercontent.com/abnste/mewu_ai/v0.2.0/docs/images/code-explanation.jpg)

[视频定位与跟踪演示 / Watch video annotation and tracking](https://github.com/abnste/mewu_ai/releases/download/v0.2.0/MewuAI-video-annotations.mp4)
